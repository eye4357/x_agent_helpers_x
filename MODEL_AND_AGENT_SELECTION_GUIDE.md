...
- Continue DOCX `bold_run_count` comparison-level parity closure by adding `comparison 3` generated/source parity immediately after closing `comparison 2`, before moving to the next family.
